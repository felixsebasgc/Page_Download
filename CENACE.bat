...
"C:\Program Files (x86)\GnuWin32\bin\wget.exe" wget -r -q -P "C:\Users\felix\Downloads\CENACE_PROYECTO" --no-check-certificate https://www.cenace.gob.ec/info-operativa/InformacionOperativa.htm

::"C:\Program Files (x86)\GnuWin32\bin\wget.exe" wget -r -P "C:\Users\felix\Downloads\CENACE_PROYECTO" --no-check-certificate https://www.cenace.gob.ec/info-operativa/InformacionOperativa.htm

::Nombre del archivo
set filename=%DATE%_%time:~0,2%-%time:~3,2%>nul

::Copia del archivo a la carpeta de almacenamiento
mkdir "C:\Users\felix\Downloads\CENACE_PROYECTO\DATOS_ORGANIZADOS\%filename%">nul 
xcopy /s "C:\Users\felix\Downloads\CENACE_PROYECTO\www.cenace.gob.ec\info-operativa" "C:\Users\felix\Downloads\CENACE_PROYECTO\DATOS_ORGANIZADOS\%filename%">nul
